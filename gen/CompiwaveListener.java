...
public interface CompiwaveListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CompiwaveParser#cwtype}.
	 * @param ctx the parse tree
	 */
	void enterCwtype(CompiwaveParser.CwtypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link CompiwaveParser#cwtype}.
	 * @param ctx the parse tree
	 */
